...
export const nb: Translations = {
  ...
  editor: {
    ...
    liveForecastPartial:
      "Prognose: {n} av solkildene dine mangler leverandør, så dens del av kurven uteblir. Legg til Helios Forecast der under Innstillinger > Dashbord > Energi > Solcellepaneler.",
    liveForecastMissing:
