...
export const it: Translations = {
  ...
  editor: {
    ...
    liveForecastPartial:
      "Previsione: {n} delle sue fonti solari non ha un fornitore, quindi manca la sua parte di curva. Vi aggiunga Helios Forecast in Impostazioni > Dashboard > Energia > Pannelli solari.",
    liveForecastMissing:
